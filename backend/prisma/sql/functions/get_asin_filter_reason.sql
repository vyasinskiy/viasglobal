...
-- Назначение: Вычисление причины фильтрации ASIN для оптовой торговли.
-- Аргументы:
--   p_asin_id INT                - ID товара ASIN в таблице ASIN
--   p_dominant_threshold INT     - Порог доминирования топового продавца (по умолчанию 90%)
--   p_min_winner_count INT       - Минимальное кол-во победителей BuyBox (по умолчанию 4, т.е. <4 или <=3 отсеиваются)
-- Возвращает:
--   TEXT - Название причины фильтрации или NULL, если товар подходит.
-- ==============================================================================
