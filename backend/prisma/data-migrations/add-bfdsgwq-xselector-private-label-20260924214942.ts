...
const TARGET_SELLER_INPUT = 'XSelector';

// Результаты и заметки анализа Private Label
const ANALYSIS_NOTES = `Добавлено по требованию пользователя для скрытия из общих SQL представлений, несмотря на 0% удержание BuyBox в текущий момент.`;
