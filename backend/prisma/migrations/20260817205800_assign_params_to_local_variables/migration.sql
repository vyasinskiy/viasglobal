-- Присваивание входных параметров локальным переменным для их отображения в отладчике (Debugger) pgAdmin 4
-- Также добавлены логи RAISE NOTICE для вывода на вкладку Messages
