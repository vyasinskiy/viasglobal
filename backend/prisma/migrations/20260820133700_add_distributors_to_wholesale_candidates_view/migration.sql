-- ==============================================================================
-- Миграция: add_distributors_to_wholesale_candidates_view
-- Назначение: Обновление представления WholesaleCandidatesView с добавлением
--             колонки distributors (перечисление дистрибьюторов через запятую).
-- ==============================================================================
