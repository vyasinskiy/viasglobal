-- Оптимизация порядка проверок в get_asin_filter_reason: легкие текстовые проверки вынесены наверх
...
BEGIN
    ...
    -- 4. ПРОВЕРКА НА ДОМИНИРУЮЩЕГО ПРОДАВЦА В ДАННОМ ASIN (DOMINANT SELLER)
