...
3. **Секция 3 (Интерактивный AI Ассистент — `AiGiftAdvisor.tsx`)**:
   - Диалоговый пошаговый опросник:
     - **Шаг 1**: Кому подарок (он / она / подростки / коллега / дом / себе).
     - **Шаг 2**: Реальная категория товаров каталога магазина:
       1. `Hogar, Cocina & Deco` (теги: `hogar-decoracion`, `hogar`, `decoracion`, `cocina`).
       2. `Papelería & Creatividad` (теги: `papeleria-creatividad`, `papeleria`, `colegio`, `oficina`).
       3. `Niños, Juguetes & Juegos` (теги: `ninos-juegos`, `ninos`, `juguetes`, `infantil`, `kidult`).
       4. `Moda, Belleza & Accesorios` (теги: `moda-accesorios`, `accesorios`, `bolso`, `belleza`).
       5. `Tecnología & Gadgets` (теги: `tecnologia-gadgets`, `gadgets`, `electronics`).
     - **Шаг 3**: Бюджет (<40€, 40-90€, >90€, любой).
   - Свободный текстовый поиск через ИИ (NLP сопоставление ключевых слов под 5 категорий).
