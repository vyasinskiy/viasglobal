...
/**
 * Клиентский компонент каталога с фильтрацией, поиском и сортировкой
 */
export function CatalogClient({ initialProducts }: CatalogClientProps) {
  ...
  useEffect(() => {
    // Обновляем список, если пришел новый initialProducts
  ...
  const filteredProducts = useMemo(() => {
    ...
    return result;
  }, [allProducts, category, searchQuery, inStockOnly, sortBy, showWishlistOnly, wishlist]);
