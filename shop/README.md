...
3. **Секция 3 (`AiGiftAdvisor.tsx` — AI Ассистент подарков)**:
   - Интерактивный AI консьерж: пошаговый опросник с **динамической адаптацией категорий под выбранного адресата** (например, для *Niños o Estudiantes* выводятся исключительно детские и школьные категории: *Juguetes & Juegos Creativos*, *Vuelta al Cole & Papelería*, *Gadgets Tech*, *Mochilas & Accesorios Infantiles*, а взрослая домашняя утварь *Hogar* исключена).
